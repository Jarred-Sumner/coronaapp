...
@objc(MediaPlayer)
final class MediaPlayer : UIView, RCTUIManagerObserver, RCTInvalidating, TrackableMediaSourceDelegate, UIVideoEditorControllerDelegate, UINavigationControllerDelegate {
